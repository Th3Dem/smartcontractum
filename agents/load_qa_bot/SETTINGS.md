# ⚙️ Инженерный регламент и параметры: load_qa_bot

> **Проект:** SmartContractum Enterprise Platform  
> **Роль:** Load & Performance QA Specialist  
> **Локация:** `/agents/load_qa_bot/`  
...
1. **Тест покоя (Resting State Benchmark):**
   - Проверить, что при отсутствии движения мыши вызовы перерисовки Canvas не потребляют лишних циклов CPU/GPU.
