...
| :-: | :--- | :--- | :-: |
| **Блок 1** | **Конструктор смарт-контрактов («Дерево решений»)** | Визуальный конструктор, парсинг узлов условий, триггеры оракулов, валидация логики | 🔥 P0 (Next) |
| **Блок 2** | **Паспорт Контракта (Contract Passport Engine)** | Формирование паспорта, хеширование, экспорт в Markdown/PDF, регуляторный чеклист | 🔥 P0 |
| **Блок 3** | **Реестр Доверенных Оракулов (Oracle Hub)** | Каталог внешних поставщиков данных, симуляция оракульных ответов, проверка подписей | ⚡ P1 |
| **Блок 4** | **AI Архитектор Контрактов (Gemini Circuit Breaker)** | Генерация деревьев решений на естественном языке от задачи пользователя | ⚡ P1 |
| **Блок 5** | **Криптографический Сейф & Эскроу (Safe & Escrow)** | Модель депонирования и транзакционного сплита средств | 🛡️ P2 |
